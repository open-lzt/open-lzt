...
export const ru = {
  ...
  hero: {
    ...
    // кто уже понял, зачем.
    sub: 'Поднимает лоты и темы, выкупает нужное по вашим условиям, сценарии собираются без кода. Стенд встаёт на ваш сервер и остаётся вашим: типизированный SDK, событийный движок, MCP-сервер. Реальные деньги не тратятся, пока сами не переключите с тестового маркета.',
